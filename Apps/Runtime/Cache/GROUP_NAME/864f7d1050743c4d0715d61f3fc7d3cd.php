...
</script><div id="main"><div class="main_left"><div class="model"><div class="model_top">官方公告<span><a href="#"></a></span></div><div class="model_content clearbimg"><ul><?php $_result=M('Announce')->where('status=1 and endtime >= "2013-09-19"')->field('id,title')->order('create_time desc')->limit(5)->select();foreach($_result as $key=>$announce):?><li><a href="<?php echo U('Announce/show',array('id'=>$announce['id']));?>" target="_blank"><?php echo (msubstr($announce["title"],0,18)); ?></a></li><?php endforeach;?></ul></div></div><div class="model"><div class="model_top">最新咨询<span><a href="<?php echo U('Article/index',array('id'=>'1'));?>" target="_blank">MORE+</a></span></div><div class="model_content"><ul><?php $_result=M('Article')->where('status=1 and catid in (1)')->field('id,title')->order('create_time desc')->limit(5)->select();foreach($_result as $key=>$article):?><li><a href="<?php echo U('Article/show',array('id'=>$article['id']));?>" target="_blank"><?php echo (msubstr($article["title"],0,18)); ?></a></li><?php endforeach;?></ul></div></div><div class="model"><div class="model_top">产品分类<span><a href="#"></a></span></div><div class="model_content clearbimg"><ul><div class="lf_tree"><?php $_list=D('Category')->where('status=1 and id in (41,37,42,38,43,39,40)')->field("*,concat(path,'-',id) as bpath")->order('bpath')->select();foreach($_list as $key=>$value):$_list[$key]['count']=count(explode('-',$value['bpath']));endforeach;$_result=$_list;foreach($_result as $key=>$category): if($_result[$key]['count'] == $_result[$key-1]['count'] or $_result[$key-1]['count'] == null): ?><li><a href="<?php echo U('Product/index',array('id'=>$category['id']));?>"><?php echo ($category["catname"]); ?></a></li><?php elseif($_result[$key]['count'] > $_result[$key-1]['count']): ?><ul><li><a href="<?php echo U('Product/index',array('id'=>$category['id']));?>"><?php echo ($category["catname"]); ?></a></li><?php elseif($_result[$key]['count'] < $_result[$key-1]['count']): ?></ul><li><a href="<?php echo U('Product/index',array('id'=>$category['id']));?>"><?php echo ($category["catname"]); ?></a></li><?php endif; endforeach;?></div></ul></div></div></div><div class="main_right"><div class="content"><div class="content_top">公司简介<span><a href="<?php echo U('Content/index',array('id'=>'36'));?>" target="_blank">MORE+</a></span></div><div class="content_main" style="padding:0 10px;"><?php $content=$_result=M('Category')->where('status=1 and id=36')->find(); echo ($content["content"]); ?></div></div><div class="content"><div class="content_top cmain">产品展示<span><a href="<?php echo U('Product/index',array('id'=>'12'));?>" target="_blank">MORE+</a></span></div><div class="content_main"><ul class="listcontent"><?php $_result=M('Product')->where('status=1 and catid in (12,41,37,42,38,43,39,40)')->order('create_time desc')->limit(9)->select();foreach($_result as $key=>$product):?><li><div class="img"><a href="<?php echo U('Product/show',array('id'=>$product['id']));?>" target="_blank"><img src="__ROOT__/Uploads<?php echo ($product["thumb"]); ?>" width="160" height="160" /></a></div><div class="title"><a href="<?php echo U('Product/show',array('id'=>$product['id']));?>" target="_blank"><?php echo (msubstr($product["title"],0,30)); ?></a></div><div class="price">价格：<span>￥<?php echo ($product["price"]); ?></span></div></li><?php endforeach;?></ul></div></div></div></div><div class="clear"></div><div class="hr1"></div><div class="links"><span>友情链接：</span><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['type'] == 0 ): if($vo['linktype'] == 0): ?><a href="<?php echo ($vo["url"]); ?>" target="_blank"><?php echo ($vo["name"]); ?></a>|
            <?php else: ?><a href="<?php echo ($vo["url"]); ?>" target="_blank"><img src="__ROOT__/Uploads<?php echo ($vo["logo"]); ?>" alt="<?php echo ($vo["name"]); ?>" /></a>|<?php endif; endif; endforeach; endif; else: echo "" ;endif; ?><a href="<?php echo U('Link/index');?>"><span style="color:red;">更多&gt;</span></a></div><div class="clear"></div><!--Powered by Yufucms!--><div id="footer"><?php $other=$_result=M('Other')->where('settag="footer"')->find(); echo $other['setvalue'];?>&nbsp;&nbsp;<?php $other=$_result=M('Other')->where('settag="cnzzstatistics"')->find(); echo $other['setvalue'];?></div></div><!--客服面板--><div id="cmsFloatPanel"><div class="ctrolPanel"><a class="arrow" href="#"><span>顶部</span></a><a class="service" href="#"><span>客服</span></a><a class="message" href="#"><span>留言</span></a><a class="qrcode" href="#"><span>微信</span></a><a class="arrow" href="#"><span>底部</span></a></div><div class="servicePanel"><div class="servicePanel-inner"><div class="serviceMsgPanel"><div class="serviceMsgPanel-hd"><a href="#"><span>关闭</span></a></div><div class="serviceMsgPanel-bd"><div class="msggroup">售前咨询</div><div class="msgtool"><?php $other=$_result=M('Other')->where('settag="qq1"')->find(); echo $other['setvalue'];?></div><div class="msggroup">售后客服</div><div class="msgtool"><?php $other=$_result=M('Other')->where('settag="qq2"')->find(); echo $other['setvalue'];?></div></div><div class="serviceMsgPanel-ft"></div></div><div class="arrowPanel"><div class="arrow02"></div></div></div></div><div class="messagePanel"><div class="messagePanel-inner"><div class="formPanel"><div class="formPanel-hd">欢迎给我们留言<a href="#"><span>关闭</span></a></div><div class="formPanel-bd"><form id="form_message" action="<?php echo U('Message/index');?>" method="post"><div><textarea name="content" id="message_content" cols="30" rows="4"></textarea></div><div>联系人： <input type="text" name="name" id="message_name" /></div><div>电 &nbsp;&nbsp; 话： <input type="text" name="tel" id="message_tel" /></div><div><input type="submit" id="submit" value="提 交" /> &nbsp;&nbsp; <input type="reset" value="重 置" /></div></form></div><div class="formPanel-ft"><a href="#"><span>鱼福网提供技术支持</span></a></div></div><div class="arrowPanel"><div class="arrow01"></div><div class="arrow02"></div></div></div></div><div class="qrcodePanel"><div class="qrcodePanel-inner"><div class="codePanel"><div class="codePanel-hd">用微信扫一扫，加为关注<a href="#"><span>关闭</span></a></div><div class="codePanel-bd"><img src="__UPLOADS__<?php echo ($wxqrcode); ?>" /></div><div class="codePanel-ft"><a href="<?php echo U('Content/index',array('id'=>48));?>"><span><< 点击下载APP手机客户端 >></span></a></div></div><div class="arrowPanel"><div class="arrow01"></div><div class="arrow02"></div></div></div></div></div><script type="text/javascript">    $(function(){
        //在线留言
